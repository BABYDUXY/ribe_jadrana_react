  ...
  return (
    <div className=" w-screen min-h-screen grid grid-rows-[repeat(10,10%);] grid-cols-[15%_1fr_15%]">
      <Link to="/" className="hover:cursor-default w-min h-min">
        <img
          className="m-10 transition-all duration-200 ease-in-out hover:cursor-pointer -scale-x-100 hover:-translate-y-1 hover:-scale-x-110 hover:scale-y-110"
          src="../img/arrow.png"
          alt=""
        />
      </Link>
      ...
      <div className="flex col-start-2 row-start-1 mt-10 bg-blue-200 rounded-lg justify-evenly row-span-10">
        ...
        <div
          ...
          className=" w-[50%] h-[18rem]flex items-center justify-center  [&>*]:my-5 text-lg h-max mt-[5%]"
        ></div>
      </div>
      <div className="col-start-2 row-start-5  rounded-lg py-4 row-span-4 w-[35%] ml-[5%] flex-col flex items-center gap-8 ">
        ...
        <ul className="flex flex-col gap-4 text-lg">
          <li>
            <b>Ostali nazivi:</b>
            <br></br>
            {value.ostali_nazivi == null ? "Nema" : value.ostali_nazivi}
          </li>
          <li>
            <b>Latinski:</b> {value.lat_ime}
          </li>
          <li>
            <b>Vrsta:</b>{" "}
            <span
              className={
                value.vrsta == "plava" ? "text-blue-600" : "text-white "
              }
            >
              {value.vrsta}
            </span>
          ...
          <li>
            <b>Dubina od </b> {value.min_dubina} m <b>do </b>
            {value.max_dubina} m
          </li>
          <li>
            <b>Max Duljina:</b> {value.max_duljina} cm
          </li>
          <li>
            <b>Max Težina:</b> {value.max_tezina} kg
          </li>
          <li>
            <b>Otrovna:</b> {value.otrovna ? "Da" : "Ne"}
          </li>
        </ul>
      </div>
    </div>
